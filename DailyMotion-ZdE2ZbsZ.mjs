import { V as P, aL as v, aM as D } from "./index-DhESz6lu.mjs";
import O from "react";
function b(t, e) {
...
var M = Object.create, s = Object.defineProperty, w = Object.getOwnPropertyDescriptor, S = Object.getOwnPropertyNames, j = Object.getPrototypeOf, T = Object.prototype.hasOwnProperty, L = (t, e, r) => e in t ? s(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, A = (t, e) => {
  for (var r in e)
  ...
  t
)), C = (t) => h(s({}, "__esModule", { value: !0 }), t), n = (t, e, r) => (L(t, typeof e != "symbol" ? e + "" : e, r), r), d = {};
A(d, {
  default: () => p
});
var _ = C(d), c = E(O), l = v, f = D;
...
n(p, "loopOnEnded", !0);
const K = /* @__PURE__ */ P(_), V = /* @__PURE__ */ b({
  __proto__: null,
  default: K
}, [_]);
export {
