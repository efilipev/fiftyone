import { V as b, aL as _, aM as O } from "./index-DhESz6lu.mjs";
import A from "react";
function R(s, e) {
...
const y = typeof navigator < "u", V = y && navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1, v = y && (/iPad|iPhone|iPod/.test(navigator.userAgent) || V) && !window.MSStream, F = y && /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && !window.MSStream, T = "https://cdn.jsdelivr.net/npm/hls.js@VERSION/dist/hls.min.js", C = "Hls", B = "https://cdnjs.cloudflare.com/ajax/libs/dashjs/VERSION/dash.all.min.js", x = "dashjs", K = "https://cdn.jsdelivr.net/npm/flv.js@VERSION/dist/flv.min.js", G = "flvjs", X = /www\.dropbox\.com\/.+/, f = /https:\/\/watch\.cloudflarestream\.com\/([a-z0-9]+)/, W = "https://videodelivery.net/{id}/manifest/video.m3u8";
class P extends d.Component {
  ...
  shouldUseHLS(e) {
    return F && this.props.config.forceSafariHLS || this.props.config.forceHLS ? !0 : v || this.props.config.forceDisableHls ? !1 : c.HLS_EXTENSIONS.test(e) || f.test(e);
  }
  shouldUseDASH(e) {
