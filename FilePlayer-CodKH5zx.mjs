import { X as b, b as _, aO as O, aP as A } from "./index-CP_g3VwS.mjs";
function R(s, e) {
...
var g = H(m), d = j(_), a = O, c = A;
const y = typeof navigator < "u", F = y && navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1, v = y && (/iPad|iPhone|iPod/.test(navigator.userAgent) || F) && !window.MSStream, V = y && /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && !window.MSStream, T = "https://cdn.jsdelivr.net/npm/hls.js@VERSION/dist/hls.min.js", C = "Hls", B = "https://cdnjs.cloudflare.com/ajax/libs/dashjs/VERSION/dash.all.min.js", x = "dashjs", K = "https://cdn.jsdelivr.net/npm/flv.js@VERSION/dist/flv.min.js", X = "flvjs", G = /www\.dropbox\.com\/.+/, f = /https:\/\/watch\.cloudflarestream\.com\/([a-z0-9]+)/, W = "https://videodelivery.net/{id}/manifest/video.m3u8";
class P extends d.Component {
  ...
  load(e) {
    ...
    }), this.shouldUseFLV(e) && (0, a.getSDK)(K.replace("VERSION", l), X).then((o) => {
  ...
  getSource(e) {
    ...
    if (!(e instanceof Array || (0, a.isMediaStream)(e) || t || i || n))
      return G.test(e) ? e.replace("www.dropbox.com", "dl.dropboxusercontent.com") : e;
  }
  render() {
...
const z = /* @__PURE__ */ b(g), J = /* @__PURE__ */ R({
  __proto__: null,
  default: z
}, [g]);
export {
