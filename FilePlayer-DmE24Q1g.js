import { W as getDefaultExportFromCjs, aM as utils, aN as patterns } from "./index-CvS5YflC.js";
...
class FilePlayer extends import_react2.Component {
  constructor() {
    super(...arguments);
    ...
    __publicField(this, "renderSourceElement", (source, index) => {
      if (typeof source === "string") {
        return /* @__PURE__ */ import_react2.default.createElement("source", { key: index, src: source });
      }
      return /* @__PURE__ */ import_react2.default.createElement("source", { key: index, ...source });
    });
    __publicField(this, "renderTrack", (track, index) => {
      return /* @__PURE__ */ import_react2.default.createElement("track", { key: index, ...track });
    });
