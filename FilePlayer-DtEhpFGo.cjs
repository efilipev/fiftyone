...
var import_utils = index.utils;
var import_patterns = index.patterns;
...
class FilePlayer extends import_react.Component {
  constructor() {
    ...
    __publicField(this, "renderSourceElement", (source, index2) => {
      if (typeof source === "string") {
        return /* @__PURE__ */ import_react.default.createElement("source", { key: index2, src: source });
      }
      return /* @__PURE__ */ import_react.default.createElement("source", { key: index2, ...source });
    });
    __publicField(this, "renderTrack", (track, index2) => {
      return /* @__PURE__ */ import_react.default.createElement("track", { key: index2, ...track });
    });
...
const FilePlayer$1 = /* @__PURE__ */ index.getDefaultExportFromCjs(FilePlayer_1);
const FilePlayer$2 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: FilePlayer$1
}, [FilePlayer_1]);
exports.FilePlayer = FilePlayer$2;
