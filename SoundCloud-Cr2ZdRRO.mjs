import { X as P, b as g, aO as b, aP as O } from "./index-CP_g3VwS.mjs";
function v(t, e) {
...
var S = Object.create, l = Object.defineProperty, w = Object.getOwnPropertyDescriptor, j = Object.getOwnPropertyNames, C = Object.getPrototypeOf, E = Object.prototype.hasOwnProperty, D = (t, e, r) => e in t ? l(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, L = (t, e) => {
  for (var r in e)
    l(t, r, { get: e[r], enumerable: !0 });
}, d = (t, e, r, s) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let o of j(e))
      !E.call(t, o) && o !== r && l(t, o, { get: () => e[o], enumerable: !(s = w(e, o)) || s.enumerable });
  return t;
}, M = (t, e, r) => (r = t != null ? S(C(t)) : {}, d(
  ...
  t
)), R = (t) => d(l({}, "__esModule", { value: !0 }), t), a = (t, e, r) => (D(t, typeof e != "symbol" ? e + "" : e, r), r), h = {};
L(h, {
  default: () => u
});
var f = R(h), p = M(g), c = b, T = O;
...
a(u, "loopOnEnded", !0);
const A = /* @__PURE__ */ P(f), F = /* @__PURE__ */ v({
  __proto__: null,
  default: A
}, [f]);
export {
