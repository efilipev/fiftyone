import { V as m, aL as f, aM as _ } from "./index-DhESz6lu.mjs";
import b from "react";
function P(t, e) {
...
var g = Object.create, l = Object.defineProperty, v = Object.getOwnPropertyDescriptor, O = Object.getOwnPropertyNames, S = Object.getPrototypeOf, L = Object.prototype.hasOwnProperty, j = (t, e, r) => e in t ? l(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, w = (t, e) => {
  for (var r in e)
    l(t, r, { get: e[r], enumerable: !0 });
}, c = (t, e, r, s) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let a of O(e))
      !L.call(t, a) && a !== r && l(t, a, { get: () => e[a], enumerable: !(s = v(e, a)) || s.enumerable });
  return t;
  ...
  t
)), D = (t) => c(l({}, "__esModule", { value: !0 }), t), o = (t, e, r) => (j(t, typeof e != "symbol" ? e + "" : e, r), r), h = {};
w(h, {
  default: () => n
});
