import { V as w, aL as D, aM as C } from "./index-DhESz6lu.mjs";
import N from "react";
function M(t, e) {
...
var I = Object.create, l = Object.defineProperty, S = Object.getOwnPropertyDescriptor, j = Object.getOwnPropertyNames, A = Object.getPrototypeOf, R = Object.prototype.hasOwnProperty, H = (t, e, r) => e in t ? l(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, x = (t, e) => {
  for (var r in e)
...
const V = "https://player.twitch.tv/js/embed/v1.js", K = "Twitch", $ = "twitch-player-";
class h extends y.Component {
  ...
  load(e, r) {
    ...
    (0, c.getSDK)(V, K).then((d) => {
      ...
      const { READY: m, PLAYING: g, PAUSE: E, ENDED: O, ONLINE: L, OFFLINE: b, SEEK: T } = d.Player;
      this.player.addEventListener(m, this.props.onReady), this.player.addEventListener(g, this.props.onPlay), this.player.addEventListener(E, this.props.onPause), this.player.addEventListener(O, this.props.onEnded), this.player.addEventListener(T, this.props.onSeek), this.player.addEventListener(L, this.props.onLoaded), this.player.addEventListener(b, this.props.onLoaded);
    }, a);
  }
  play() {
...
o(h, "loopOnEnded", !0);
const W = /* @__PURE__ */ w(f), k = /* @__PURE__ */ M({
  __proto__: null,
  default: W
}, [f]);
export {
