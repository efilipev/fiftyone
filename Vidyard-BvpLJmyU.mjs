import { X as g, b as v, aO as b, aP as O } from "./index-CP_g3VwS.mjs";
function V(t, e) {
...
var D = Object.create, i = Object.defineProperty, j = Object.getOwnPropertyDescriptor, w = Object.getOwnPropertyNames, S = Object.getPrototypeOf, M = Object.prototype.hasOwnProperty, A = (t, e, r) => e in t ? i(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, E = (t, e) => {
  for (var r in e)
    i(t, r, { get: e[r], enumerable: !0 });
}, h = (t, e, r, s) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let a of w(e))
      !M.call(t, a) && a !== r && i(t, a, { get: () => e[a], enumerable: !(s = j(e, a)) || s.enumerable });
  return t;
}, L = (t, e, r) => (r = t != null ? D(S(t)) : {}, h(
  ...
  t
)), R = (t) => h(i({}, "__esModule", { value: !0 }), t), o = (t, e, r) => (A(t, typeof e != "symbol" ? e + "" : e, r), r), _ = {};
E(_, {
  default: () => y
});
...
const T = /* @__PURE__ */ g(f), K = /* @__PURE__ */ V({
  __proto__: null,
  default: T
}, [f]);
export {
