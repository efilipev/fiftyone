import { V as g, aL as v, aM as b } from "./index-DhESz6lu.mjs";
import O from "react";
function V(t, e) {
...
var D = Object.create, n = Object.defineProperty, j = Object.getOwnPropertyDescriptor, w = Object.getOwnPropertyNames, M = Object.getPrototypeOf, S = Object.prototype.hasOwnProperty, L = (t, e, r) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, A = (t, e) => {
  for (var r in e)
    n(t, r, { get: e[r], enumerable: !0 });
}, h = (t, e, r, o) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let a of w(e))
      !S.call(t, a) && a !== r && n(t, a, { get: () => e[a], enumerable: !(o = j(e, a)) || o.enumerable });
  return t;
}, R = (t, e, r) => (r = t != null ? D(M(t)) : {}, h(
  ...
  t
)), E = (t) => h(n({}, "__esModule", { value: !0 }), t), s = (t, e, r) => (L(t, typeof e != "symbol" ? e + "" : e, r), r), _ = {};
A(_, {
  default: () => d
});
