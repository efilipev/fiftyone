import { V as d, aL as f, aM as m } from "./index-DhESz6lu.mjs";
import _ from "react";
function P(t, e) {
...
var g = Object.create, n = Object.defineProperty, b = Object.getOwnPropertyDescriptor, v = Object.getOwnPropertyNames, O = Object.getPrototypeOf, D = Object.prototype.hasOwnProperty, M = (t, e, r) => e in t ? n(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, w = (t, e) => {
  for (var r in e)
  ...
  t
)), L = (t) => h(n({}, "__esModule", { value: !0 }), t), i = (t, e, r) => (M(t, typeof e != "symbol" ? e + "" : e, r), r), c = {};
w(c, {
  default: () => l
});
var y = L(c), p = j(_), u = f, V = m;
const S = "https://player.vimeo.com/api/player.js", E = "Vimeo", k = (t) => t.replace("/manage/videos", "");
class l extends p.Component {
  ...
  load(e) {
    this.duration = null, (0, u.getSDK)(S, E).then((r) => {
      if (!this.container)
        return;
