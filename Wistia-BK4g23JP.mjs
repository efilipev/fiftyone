import { X as m, b as g, aO as v, aP as w } from "./index-CP_g3VwS.mjs";
function O(t, e) {
...
var C = Object.create, i = Object.defineProperty, k = Object.getOwnPropertyDescriptor, D = Object.getOwnPropertyNames, E = Object.getPrototypeOf, S = Object.prototype.hasOwnProperty, R = (t, e, a) => e in t ? i(t, e, { enumerable: !0, configurable: !0, writable: !0, value: a }) : t[e] = a, j = (t, e) => {
  for (var a in e)
  ...
  t
)), M = (t) => h(i({}, "__esModule", { value: !0 }), t), n = (t, e, a) => (R(t, typeof e != "symbol" ? e + "" : e, a), a), d = {};
j(d, {
  default: () => l
});
...
n(l, "loopOnEnded", !0);
const L = /* @__PURE__ */ m(_), T = /* @__PURE__ */ O({
  __proto__: null,
  default: L
}, [_]);
export {
