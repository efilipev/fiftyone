import { X as U, b as I, aO as L, aP as M } from "./index-CP_g3VwS.mjs";
function Y(a, e) {
...
var k = Object.create, u = Object.defineProperty, N = Object.getOwnPropertyDescriptor, j = Object.getOwnPropertyNames, V = Object.getPrototypeOf, B = Object.prototype.hasOwnProperty, x = (a, e, t) => e in a ? u(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[e] = t, K = (a, e) => {
  for (var t in e)
    u(a, t, { get: e[t], enumerable: !0 });
}, v = (a, e, t, s) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let r of j(e))
      !B.call(a, r) && r !== t && u(a, r, { get: () => e[r], enumerable: !(s = N(e, r)) || s.enumerable });
  return a;
  ...
  a
)), H = (a) => v(u({}, "__esModule", { value: !0 }), a), o = (a, e, t) => (x(a, typeof e != "symbol" ? e + "" : e, t), t), w = {};
K(w, {
  default: () => O
});
var S = H(w), b = F(I), c = L, D = M;
...
class O extends b.Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ b.default.createElement("div", { style: t }, /* @__PURE__ */ b.default.createElement("div", { ref: this.ref }));
  }
}
