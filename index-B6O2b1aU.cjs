...
function queryString(analytics, query) {
  ...
  var params = parsed.split("&").reduce(function(acc, str) {
    ...
    acc[k] = index.gracefulDecodeURIComponent(v);
    return acc;
  }, {});
  var calls = [];
  var ajs_uid = params.ajs_uid, ajs_event = params.ajs_event, ajs_aid = params.ajs_aid;
  var _a = index.isPlainObject(analytics.options.useQueryString) ? analytics.options.useQueryString : {}, _b = _a.aid, aidPattern = _b === void 0 ? /.+/ : _b, _c = _a.uid, uidPattern = _c === void 0 ? /.+/ : _c;
  if (ajs_aid) {
