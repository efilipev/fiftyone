import { ao as __awaiter, ap as __generator, aq as loadScript, ar as getNextIntegrationsURL, as as unloadScript, at as __spreadArray, au as recordIntegrationMetric, av as isOffline, aw as __assign, ax as ContextCancelation, ay as applyDestinationMiddleware, az as dist, aA as isServer, aB as mergedOptions, aC as isPlainObject, aD as pWhile, aE as createDeferred, aF as PriorityQueue, aG as PersistedPriorityQueue, aH as attempt, aI as isOnline, aJ as Context } from "./index-CvS5YflC.js";
import { i as isPlanEventEnabled } from "./is-plan-event-enabled-DgzlHDEs.js";
...
var LegacyDestination = (
  ...
  function() {
    ...
    LegacyDestination2.prototype.track = function(ctx) {
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_a) {
          return [2, this.send(ctx, dist.Track, "track")];
        });
      });
    };
      ...
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_b) {
          switch (_b.label) {
            ...
            case 1:
              _b.sent();
              return [2, this.send(ctx, dist.Page, "page")];
          }
        });
      });
    };
    LegacyDestination2.prototype.identify = function(ctx) {
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_a) {
          return [2, this.send(ctx, dist.Identify, "identify")];
        });
      });
    };
    LegacyDestination2.prototype.alias = function(ctx) {
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_a) {
          return [2, this.send(ctx, dist.Alias, "alias")];
        });
      });
    };
    LegacyDestination2.prototype.group = function(ctx) {
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(_a) {
          return [2, this.send(ctx, dist.Group, "group")];
        });
      });
    };
