...
function recordLoadMetrics(fullPath, ctx, name) {
  ...
  try {
    ...
    metric && ctx.stats.gauge("legacy_destination_time", Math.round(metric.duration), index.__spreadArray([
      name
    ...
    return index.__generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          path = index.getNextIntegrationsURL();
        ...
        case 1:
          _a.trys.push([1, 3, , 4]);
          return [4, index.loadScript(fullPath)];
        case 2:
          _a.sent();
        ...
        case 4:
          ...
          return [
            ...
            Promise.all(deps.map(function(dep) {
              return index.loadScript(path + dep + ".gz");
            }))
            // @ts-ignore
          ];
        case 5:
...
function unloadIntegration(name, version, obfuscate) {
  return index.__awaiter(this, void 0, void 0, function() {
    ...
    return index.__generator(this, function(_a) {
      ...
      fullPath = "".concat(path, "/integrations/").concat(obfuscatedPathName !== null && obfuscatedPathName !== void 0 ? obfuscatedPathName : pathName, "/").concat(version, "/").concat(obfuscatedPathName !== null && obfuscatedPathName !== void 0 ? obfuscatedPathName : pathName, ".dynamic.js.gz");
      return [2, index.unloadScript(fullPath)];
    });
  });
}
    ...
    return index.__generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4,
            index.pWhile(function() {
              return queue.length > 0 && index.isOnline();
            }, function() {
              return index.__awaiter(_this, void 0, void 0, function() {
                var ctx, result, success;
                return index.__generator(this, function(_a2) {
                  switch (_a2.label) {
                    case 0:
                      ctx = queue.pop();
                      if (!ctx) {
                      ...
                      return [4, index.attempt(ctx, xt)];
                    case 1:
                      result = _a2.sent();
                      success = result instanceof index.Context;
                      if (!success) {
...
var LegacyDestination = (
  ...
  function() {
    function LegacyDestination2(name, version, writeKey, settings, options, integrationSource) {
      ...
      this.middleware = [];
      this.initializePromise = index.createDeferred();
      this.flushing = false;
      this.name = name;
      this.version = version;
      this.settings = index.__assign({}, settings);
      ...
      this.buffer = options.disableClientPersistence ? new index.PriorityQueue(4, []) : new index.PersistedPriorityQueue(4, "".concat(writeKey, ":dest-").concat(name));
      this.scheduleFlush();
    }
        ...
        return index.__generator(this, function(_c) {
          switch (_c.label) {
            case 0:
              ...
              if (!((_a = this.integrationSource) !== null && _a !== void 0)) return [3, 1];
              _b = _a;
              return [3, 3];
            case 1:
            ...
            case 3:
              ...
              try {
                index.recordIntegrationMetric(ctx, {
    ...
    LegacyDestination2.prototype.shouldBuffer = function(ctx) {
      return (
        ...
        ctx.event.type !== "page" && (index.isOffline() || this._ready !== true || this._initialized !== true)
      );
    };
      ...
      return index.__awaiter(this, void 0, void 0, function() {
        ...
        return index.__generator(this, function(_c) {
          switch (_c.label) {
            case 0:
              ...
              if (plan && ev && this.name !== "Segment.io") {
                ...
                if (!isPlanEventEnabled.isPlanEventEnabled(plan, planEvent)) {
                  ...
                  ctx.cancel(new index.ContextCancelation({
                    retry: false,
                    reason: "Event ".concat(ev, " disabled for integration ").concat(this.name, " in tracking plan"),
                    type: "Dropped by plan"
                  }));
                } else {
                  ctx.updateEvent("integrations", index.__assign(index.__assign({}, ctx.event.integrations), planEvent === null || planEvent === void 0 ? void 0 : planEvent.integrations));
                }
              ...
              return [4, index.applyDestinationMiddleware(this.name, ctx.event, this.middleware)];
            case 1:
            ...
            case 2:
              _c.trys.push([2, 5, , 6]);
              if (!this.integration) return [3, 4];
    ...
    LegacyDestination2.prototype.track = function(ctx) {
      return index.__awaiter(this, void 0, void 0, function() {
        return index.__generator(this, function(_a) {
          return [2, this.send(ctx, index.dist.Track, "track")];
        });
      });
    };
      ...
      return index.__awaiter(this, void 0, void 0, function() {
        return index.__generator(this, function(_b) {
          switch (_b.label) {
            ...
            case 1:
              _b.sent();
              return [2, this.send(ctx, index.dist.Page, "page")];
          }
        });
      });
    };
    LegacyDestination2.prototype.identify = function(ctx) {
      return index.__awaiter(this, void 0, void 0, function() {
        return index.__generator(this, function(_a) {
          return [2, this.send(ctx, index.dist.Identify, "identify")];
        });
      });
    };
    LegacyDestination2.prototype.alias = function(ctx) {
      return index.__awaiter(this, void 0, void 0, function() {
        return index.__generator(this, function(_a) {
          return [2, this.send(ctx, index.dist.Alias, "alias")];
        });
      });
    };
    LegacyDestination2.prototype.group = function(ctx) {
      return index.__awaiter(this, void 0, void 0, function() {
        return index.__generator(this, function(_a) {
          return [2, this.send(ctx, index.dist.Group, "group")];
        });
      });
    };
      ...
      setTimeout(function() {
        return index.__awaiter(_this, void 0, void 0, function() {
          ...
          return index.__generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                if (index.isOffline() || this._ready !== true || this._initialized !== true) {
                  this.scheduleFlush();
                  return [
                    2
                    /*return*/
...
function ajsDestinations(writeKey, settings, globalIntegrations, options, routingMiddleware, legacyIntegrationSources) {
  ...
  var integrationOptions = index.mergedOptions(settings, options !== null && options !== void 0 ? options : {});
  var adhocIntegrationSources = legacyIntegrationSources === null || legacyIntegrationSources === void 0 ? void 0 : legacyIntegrationSources.reduce(function(acc, integrationSource) {
    var _a2;
    return index.__assign(index.__assign({}, acc), (_a2 = {}, _a2[resolveIntegrationNameFromSource(integrationSource)] = integrationSource, _a2));
  }, {});
  var installableIntegrations = new Set(index.__spreadArray(index.__spreadArray([], Object.keys(remoteIntegrationsConfig).filter(function(name) {
    ...
    return index.isPlainObject(remoteIntegrationsConfig[name]) || index.isPlainObject(localIntegrationsConfig === null || localIntegrationsConfig === void 0 ? void 0 : localIntegrationsConfig[name]);
  }), true));
