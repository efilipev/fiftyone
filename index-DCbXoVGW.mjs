import { aq as v, ar as w, aC as g, at as M, as as N } from "./index-CP_g3VwS.mjs";
function j(s, p, h) {
  var i;
  return v(this, void 0, void 0, function() {
    ...
    return w(this, function(u) {
      switch (u.label) {
        case 0:
          return g() ? [2, []] : (o = M(), c = (i = p.enabledMiddleware) !== null && i !== void 0 ? i : {}, l = Object.entries(c).filter(function(r) {
            r[0];
            var e = r[1];
            return e;
          }).map(function(r) {
