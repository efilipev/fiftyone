import { aN as k, aE as E } from "./index-CP_g3VwS.mjs";
function f(a, i) {
...
function Q(a, i) {
  ...
  var s = e.search.slice(1), r = s.split("&").reduce(function(o, P) {
    ...
    return o[b] = k(S), o;
  }, {}), t = [], p = r.ajs_uid, c = r.ajs_event, m = r.ajs_aid, n = E(a.options.useQueryString) ? a.options.useQueryString : {}, u = n.aid, l = u === void 0 ? /.+/ : u, _ = n.uid, A = _ === void 0 ? /.+/ : _;
  if (m) {
