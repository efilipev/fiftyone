...
function Starter(props) {
  const { mode } = props;
  const { isLoading } = index.useOperators(true);
  const datasetName = index.Recoil_index_20(index.datasetName);
  if (!mode) return null;
  if (isLoading) return /* @__PURE__ */ React.createElement(index.Loading, null, "Pixelating...");
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(index.OperatorCore, null), /* @__PURE__ */ React.createElement(
    index.Stack,
    {
      spacing: 6,
      divider: /* @__PURE__ */ React.createElement(index.Divider, { sx: { width: "100%" } }),
      sx: {
        fontWeight: "normal",
        alignItems: "center",
        width: "100%",
      ...
      className: index.scrollable
    },
    /* @__PURE__ */ React.createElement(index.Stack, { alignItems: "center", spacing: 1 }, /* @__PURE__ */ React.createElement(index.Typography, { sx: { fontSize: 16 } }, title), isSelectDataset && /* @__PURE__ */ React.createElement(index.Typography, { color: "text.secondary" }, "You can use the selector above to open an existing dataset"), /* @__PURE__ */ React.createElement(StarterSubtitle, { ...props }), !isSelectDataset && /* @__PURE__ */ React.createElement(index.Typography, { color: "text.secondary" }, /* @__PURE__ */ React.createElement(
      index.Link$1,
      {
        href: learnMoreLink,
        target: "_blank",
    ...
    /* @__PURE__ */ React.createElement(index.Stack, { alignItems: "center" }, /* @__PURE__ */ React.createElement(index.Typography, { sx: { fontSize: 16 } }, codeTitle), /* @__PURE__ */ React.createElement(index.Typography, { sx: { pb: 2 }, color: "text.secondary" }, "You can use Python to ", mode === "ADD_DATASET" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(InvertedUnderlineLink, { href: learnMoreLink, target: "_blank" }, "load data"), " into FiftyOne"), isSelectDataset && /* @__PURE__ */ React.createElement(React.Fragment, null, "load a dataset in the App"), mode === "ADD_SAMPLE" && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(InvertedUnderlineLink, { href: learnMoreLink, target: "_blank" }, "add samples"), " to this dataset")), /* @__PURE__ */ React.createElement(
      index.CodeTabs,
      {
...
function StarterSubtitle(props) {
  const { mode } = props;
  const browser = index.useOperatorBrowser();
  const isAddSample = mode === "ADD_SAMPLE";
  const hasOperator = React.useCallback(
    (uri) => {
  ...
  const hasCreateDatasetOperator = React.useMemo(() => {
    if (!isAddSample) {
      return hasOperator(CREATE_DATASET_OPERATOR);
    }
    return false;
  }, [isAddSample, hasOperator]);
  const hasImportSamplesOperator = React.useMemo(() => {
    if (isAddSample) {
  ...
  return /* @__PURE__ */ React.createElement(index.Typography, { color: "text.secondary" }, hasRequiredOperator ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(OperatorLauncher, { uri: OPERATOR_URI }), "to ", clickActionLabel) : /* @__PURE__ */ React.createElement(React.Fragment, null, "Did you know? You can ", installActionLabel, " in the App by installing the ", /* @__PURE__ */ React.createElement(InvertedUnderlineLink, { href: installLink, target: "_blank" }, installLabel), " plugin"), ", or ", /* @__PURE__ */ React.createElement(ButtonLink, { onClick: browser.toggle }, "browse operations"), " for other options");
}
function OperatorLauncher(props) {
  const { uri, prompt = true } = props;
  const promptForInput = index.usePromptOperatorInput();
  const { execute } = index.useOperatorExecutor(uri);
  ...
  return /* @__PURE__ */ React.createElement(ButtonLink, { onClick: handleClick }, "Click here");
}
...
(function(exports2) {
  ...
  exports2["default"] = exports2.GA4 = void 0;
...
(function(exports2) {
  ...
  exports2["default"] = exports2.ReactGAImplementation = void 0;
  ...
  exports2.ReactGAImplementation = ReactGAImplementation;
  var _default = _ga["default"];
  exports2["default"] = _default;
})(dist);
const ReactGA = /* @__PURE__ */ index.getDefaultExportFromCjs(dist);
const gaConfig = {
  app_ids: {
    prod: "G-NT3FLN0QHF",
    dev: "G-7TMZEFFWB7"
...
function AnalyticsConsent({
  ...
  const [_, setAnalyticsInfo] = index.useAnalyticsInfo();
  ...
  return /* @__PURE__ */ React.createElement(PinBottom, null, /* @__PURE__ */ React.createElement(
    index.Grid,
    {
      container: true,
      direction: "column",
    ...
    /* @__PURE__ */ React.createElement(index.Grid, { padding: 2 }, /* @__PURE__ */ React.createElement(index.Typography, { variant: "h6", marginBottom: 1 }, "Help us improve FiftyOne"), /* @__PURE__ */ React.createElement(index.Typography, { marginBottom: 1 }, "We use cookies to understand how FiftyOne is used and improve the product. You can help us by enabling anonymous analytics."), /* @__PURE__ */ React.createElement(index.Grid, { container: true, gap: 2, justifyContent: "end", direction: "row" }, /* @__PURE__ */ React.createElement(index.Grid, { item: true, alignContent: "center" }, /* @__PURE__ */ React.createElement(index.Link$1, { style: { cursor: "pointer" }, onClick: handleDisable }, "Disable")), /* @__PURE__ */ React.createElement(index.Grid, { item: true }, /* @__PURE__ */ React.createElement(index.Button, { variant: "contained", onClick: handleEnable }, "Enable"))))
  ));
}
function PinBottom({ children }) {
  return /* @__PURE__ */ React.createElement(index.Box, { position: "fixed", bottom: 0, width: "100%", zIndex: 51 }, children);
}
...
function Analytics({ fragment }) {
  const info = index.reactRelay.useFragment(
    index.reactRelay.graphql`
  ...
  return /* @__PURE__ */ React.createElement(AnalyticsConsent, { callGA, info });
}
const Nav = ({ children, fragment }) => {
  const data = index.reactRelay.useFragment(
    index.relayRuntime.graphql`
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, children, /* @__PURE__ */ React.createElement(Analytics, { fragment: data }));
};
