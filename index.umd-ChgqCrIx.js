import { W as getDefaultExportFromCjs } from "./index-CvS5YflC.js";
  ...
  !function(e, t) {
    ...
    return function(e) {
      ...
      return a.m = e, a.c = t, a.d = function(e2, t2, n) {
        ...
        if (1 & t2 && (e2 = a(e2)), 8 & t2) return e2;
        if (4 & t2 && "object" == typeof e2 && e2 && e2.__esModule) return e2;
        var n = /* @__PURE__ */ Object.create(null);
        if (a.r(n), Object.defineProperty(n, "default", { enumerable: true, value: e2 }), 2 & t2 && "string" != typeof e2) for (var i in e2) a.d(n, i, (function(t3) {
          return e2[t3];
        }).bind(null, i));
        return n;
      }, a.n = function(e2) {
      ...
      var n = "function" == typeof fetch ? fetch.bind() : function(e2, t2) {
        return t2 = t2 || {}, new Promise(function(a2, n2) {
          ...
          for (var r in i.open(t2.method || "get", e2, true), t2.headers) i.setRequestHeader(r, t2.headers[r]);
          function o() {
            var e3, t3 = [], a3 = [], n3 = {};
      ...
      var o = function(e2) {
        ...
        return function(e3, t3) {
          ...
          for (var a2 in t3) this.registerHandler(a2, t3[a2]);
        ...
        return function(e3, t3) {
          ...
          return new Promise(function(t3, a2) {
            ...
            (0, i.default)("https://www.googleapis.com/youtube/v3/videos?id=" + o2 + "&part=snippet,contentDetails&key=" + e3.apiKey).then(function(e4) {
              ...
              for (i2 = 0; i2 < r2.length; i2++) e3.metadata[i2].playback = { total_length: n3, video_player: "youtube" };
              t3();
            }).catch(function(t4) {
      ...
      function l(e2) {
        ...
        return t2 = t2.slice(1).map(function(e3) {
          if (null != e3) return e3.replace(/\D/, "");
...
const index_umd = /* @__PURE__ */ getDefaultExportFromCjs(index_umdExports);
const index_umd$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: index_umd
}, [index_umdExports]);
export {
